...
public class CsvExporter {
    ...
    public static void exportPatients(List<Patient> patients, Window owner) {
        ...
        try (PrintWriter writer = new PrintWriter(file)) {
            writer.println("ID,Nom,Prenom,Date naissance,Sexe,Telephone,Surveillance,Remarques");
            ...
            AlertUtil.showInfo("Export réussi", "Les patients ont été exportés avec succès.");
    ...
    public static void exportTreatments(List<Treatment> treatments, Window owner) {
        ...
        try (PrintWriter writer = new PrintWriter(file)) {
            writer.println("ID,Patient,Traitement,Type,Posologie,Date debut,Date fin,Actif,Duree,Prises par jour,Progression");

            for (Treatment t : treatments) {
                writer.printf("%d,%s,%s,%s,%s,%s,%s,%s,%d,%d,%.2f%n",
                        t.getId(),
            ...
            AlertUtil.showInfo("Export réussi", "Les traitements ont été exportés avec succès.");
